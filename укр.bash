...
show_usage() {
    ...
    echo -e "  встановити       ${COLOR_DIM}<програма> [версія]${COLOR_RESET}  Встановити програму"
    echo -e "  видалити         ${COLOR_DIM}<програма> [версія]${COLOR_RESET}  Видалити програму"
    echo -e "  використовувати  ${COLOR_DIM}<програма> <версія>${COLOR_RESET}  Переключитися на версію"
    echo -e "  використовується ${COLOR_DIM}[програма]${COLOR_RESET}           Показати поточну версію"
    echo -e "  встановлені      ${COLOR_DIM}[програма]${COLOR_RESET}           Список встановлених"
    echo -e "  доступні         ${COLOR_DIM}[програма]${COLOR_RESET}           Список доступних"
    echo ""
    echo -e "${COLOR_BOLD}Приклади:${COLOR_RESET}"
    echo -e "  ${COLOR_DIM}# Встановити останню версію${COLOR_RESET}"
    echo -e "  укр встановити ціль"
    echo ""
    echo -e "  ${COLOR_DIM}# Встановити конкретну версію${COLOR_RESET}"
    echo -e "  укр встановити мавка 0.123.0"
    echo ""
}
